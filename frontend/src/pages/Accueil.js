...
const Accueil = () => {
    ...
    return(
        ...
        <Navigation/>
        <h1>Site gratuit de partage d'images</h1>
        <h2>Inscription</h2>
        <p>
        ...
        <h2>Mettre en ligne une image</h2>
        <p>
            Pour mettre en ligne une image il faut cliquer sur "Mettre en ligne une image" 
            dans la barre de navigation en haut de la page. Ensuite vous 
            aurez acces a un formulaire de mise en ligne de votre image. 
            Premierement il faut remplir le champ "nom" avec le nom de votre 
            image, deuxiemement il faut choisir un fichier image et troisiemement 
        ...
        <p>
            Pour rechercher une image il faut cliquer sur "Rechercher" 
        ...
        <h2>Acceder a une image</h2>
        <p>
            Pour acceder a une image il faut cliquer sur une image sous la barre de recherche.
        </p>
        <h2>Telecharger une image</h2>
        <p>
            Pour pouvoir telecharger une image il faut acceder a la page de l'image en question et 
